  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProductController>(initState: (_) {
      ...
      return RefreshIndicator(
        onRefresh: () => Future.sync(search == null
              ...
              controller.isListView
                      ...
                      child: PagedListView<int, ProductData>(
                        ...
                        builderDelegate: PagedChildBuilderDelegate<ProductData>(
                          itemBuilder: (context, item, index) {
                            ...
                            if (item.count == null || item.count == 0) {
                              if (item.variantsCount != 1) {
                                ...
                                type = 2;
                              } else if (item.stockStatusName != null &&
                                  item.stockStatusName == 'OUTOFSTOCK') {
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          item.salesPrice !=
                                                                  ...
                                                                  padding:
                                                                      const EdgeInsets
                                                                          ...
                                                                          bottom:
                                                                              1.0),
                                                                  child: Text(
                                                                    '${AppStrings.rupeeSymbol}${item.mrp!.toStringAsFixed(1)}',
                                                                    style:
                                                                        const TextStyle(
                                                                      color: AppColors
                                                                          .grayColor,
                                                              ...
                                                              : Container(),
                                                          Text(
                                                            '${AppStrings.rupeeSymbol}${item.salesPrice!.toStringAsFixed(1)}',
                                                            style: const TextStyle(
                                                                color: AppColors
                                                                    .black,
                                                                fontWeight:
                                                            ...
                                                            : Row(
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                      onTap:
                                                                          () {
                                                                        if (item.variantsCount !=
                                                                            1) {
                                                                          // veriant
                                                                          productDetailController.viewVariants(
                                                                              item,
                                                                              controller);
                                                                        } else {
                                                                          if (item.count ==
                                          ...
                                          child: Center(
                                            child: Padding(
                                              padding: const EdgeInsets.only(
                                                  ...
                                                  right: 5),
                                              child: Text(
                                                'Save ${AppStrings.rupeeSymbol}${item.discountAmount!.toStringAsFixed(1)}',
                                                style: TextStyle(
                                                    color: AppColors.appColor,
                                                    fontSize: 9,
                                                    fontWeight:
                          ...
                          noItemsFoundIndicatorBuilder: (_) => Center(
                              child: Image.asset(
                                  height: 150, AppImages.emptyProduct)),
                  ...
                  : Expanded(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        childAspectRatio:
                            aspectRatio, // Aspect ratio of each item
                      ),
                      builderDelegate: PagedChildBuilderDelegate<ProductData>(
                        itemBuilder: (context, item, index) {
                          var btnBgColor = AppColors.white;
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          onTap: () {
                                            productDetailController.viewDetails(
                                                item,
                                                item.productCode!,
                                                false,
                                                controller);
                        ...
                        newPageProgressIndicatorBuilder: (_) => Center(
                            child:
                                Image.asset(height: 100, AppImages.appLogoImg)),
                      ),
                    )),
            ],
          ),
